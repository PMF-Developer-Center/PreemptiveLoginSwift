...
class LoginViewController: UIViewController {
    ...
    @objc func loginSuccess(){
        ...
        let Protectedvc = mainStory.instantiateViewController(withIdentifier: "ProtectedSceneID")
        self.navigationController?.pushViewController(Protectedvc, animated:true)
